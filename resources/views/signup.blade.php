...
<!-- Mirrored from localhost:3000/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 May 2017 09:15:39 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
		<meta charset="utf-8">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<title>
				Signup Page &middot; Worditt - create words for anything
		</title>
		...
		<div class="row">
			<div class="medium-3 columns medium-centered">
				<div class="main-first-content sign up">
					...
					<form data-abide novalidatemethod="POST" action="{{ url('/register') }}">
                        {{ csrf_field() }}
						<div class="row">
