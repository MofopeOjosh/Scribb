...
<!--<![endif]-->
	<head>
		...
		<title>
				Search Results &middot; Worditt - create words for anything
		</title>
		...
		<div class="top-bar">
			<div class="row">
				<div class="medium-12 columns">
					<a href="index.html" class="site-home">
					...
					<div class="top-bar-right">
						<ul class="menu">
							...
							<li><a href="#">Dante Lex <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
  				...
  				<div class="column column-block">
						<div class="situation-content-card">
							<div class="situation-content-item">
								<a href="#" class="situation-content-text">
						...
						<div class="wordsadd-content-card">
							<div class="wordsadd-content-item">
								...
								<div class="wordsadd-content-text">
									<a href="#">Looking for food in the fridge multiple times within a short time frame, while knowing that no food is in there</a>
								</div>
					...
					<div class="column column-block">
						<div class="situation-content-card">
							<div class="situation-content-item">
								<a href="#" class="situation-content-image">
									<img src="/img/pages/dante.jpg" alt="">
								</a>
								<div class="sub-item">
									<div><a href="#"><i class="fa fa-heart" aria-hidden="true"></i> 12</a></div>
									<div>12:30pm</div>
					...
					<div class="column column-block">
						<div class="clearfix follow-cotent-card">
							<div class="float-left follow-content-left">
								<a href="#" class="follow-user-image" data-rep-placeholder-avatar data-rep-background-uimage="img/pages/dante.jpg"></a>
								<div class="follow-user-details">
									<a href="#" class="follow-user-name">Dante Lex</a>
