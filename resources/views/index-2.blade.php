...
<!-- Mirrored from localhost:3000/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 May 2017 09:15:39 GMT -->
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
		<link type="application/opensearchdescription+xml" rel="search" href="osd.html"/>

		<link rel='shortcut icon' href="img/global/favicon-1.ico" type='image/x-icon'>
...
<body class=""><script id="__bs_script__">//<![CDATA[
    document.write("<script async src='browser-sync/browser-sync-client8d33.js?v=2.18.8'><\/script>".replace("HOST", location.hostname));
//]]></script>
		...
		<div class="top-bar">
			<div class="row">
				<div class="medium-12 columns">
					<a href="index-2.html" class="site-home">
					...
					<div class="top-bar-right">
						<ul class="menu">
							...
							<li><a href="#createPost" class="button small">Submit a situation</a></li>
							<li><a href="#help">Help</a></li>
							<li><a href="#auth">Sign In <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="medium-8 columns">
				<div class="home-nav-wrapper menu-centered">
					<ul class="tabs menu" data-deep-link="true" id="home-tabs" data-tabs>
						...
						<li class="tabs-title"><a href="#trending">Trending <span>(234)</span></a></li>
						<li class="tabs-title"><a href="#recommended">Recommended <span>(234)</span></a></li>
				...
				<div class="main-content-wrapper">
					<div class="tabs-content" data-tabs-content="home-tabs">
							...
							<div class="main-content-card">
								...
								<div class="card-content-text-wrapper">
									<div class="card-content-image card-content">
										<img data-rep-lazy="/img/pages/dante.jpg">
									</div>
									<div class="card-keyword-wrapper">
										<div class="card-keyword">Keywords:</div>
										<ul class="menu card-keyword-list">
						...
						<div class="tabs-panel" id="trending">
							<div class="main-content-card">
								<div class="clearfix card-info">
									<div class="float-left">
										<div class="sub-item">
						...
						<div class="tabs-panel" id="recommended">
							<div class="main-content-card">
								<div class="clearfix card-info">
									<div class="float-left">
										<div class="sub-item">
		...
		<div class="row">
			<div class="medium-3 columns medium-centered">
				<div class="main-first-content login">
					...
					<div class="row">
						<div class="medium-12 columns">
							<a href="signup.html" class="auth-signup-link">Don't have an account? Sign Up</a>
						</div>
					</div>
					<div class="row">
						<div class="medium-9 columns medium-centered">
